					...
					<div class="app-container container-xxl d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
							<a href="../../demo32/dist/index.html">
								<img alt="Logo" src="{{ asset('/') }}assets/media/logos/demo32-small.svg" class="h-25px d-lg-none" />
								<img alt="Logo" src="{{ asset('/') }}assets/media/logos/demo32.svg" class="h-25px d-none d-lg-inline" />
							</a>
						</div>
						<!--end::Logo-->
