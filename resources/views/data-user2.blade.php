				...
				<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
					...
					<tbody class="fw-semibold text-gray-600">
						<tr>
							...
							<td>
								<a href="../../demo32/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
							</td>
							<td>
							...
							<img src="{{ asset('/') }}assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 1315</td>
							...
							<td class="text-end">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
									...
									<div class="menu-item px-3">
										<a href="../../demo32/dist/apps/customers/view.html" class="menu-link px-3">View</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu item-->
									<div class="menu-item px-3">
						...
						<tr>
							...
							<td>
								<a href="../../demo32/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
							</td>
							<td>
							...
							<td>Google</td>
							<td data-filter="visa">
							<img src="{{ asset('/') }}assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 7953</td>
						...
						<tr>
							...
							<td>
								<a href="../../demo32/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
							</td>
							<td>
							...
							<td>Bistro Union</td>
							<td data-filter="mastercard">
							<img src="{{ asset('/') }}assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 2192</td>
						...
						<tr>
							...
							<td>
								<a href="../../demo32/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
							</td>
							<td>
							...
							<img src="{{ asset('/') }}assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 8671</td>
						...
						<tr>
							...
							<td>
								<a href="../../demo32/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
							</td>
							<td>
							...
							<td>-</td>
							<td data-filter="visa">
							<img src="{{ asset('/') }}assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 2735</td>
		...
		<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
			...
			<div class="modal-dialog modal-dialog-centered mw-650px">
				...
				<div class="modal-content">
					<!--begin::Form-->
					<form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="../../demo32/dist/apps/customers/list.html">
						<!--begin::Modal header-->
